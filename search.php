		...
		<?php
			...
			else
			{
				while($row = $result->fetch_assoc())
				{
						...
						$image=$row['icon_name'];
						$data =  "Product ID = ".$productid."<br>"."Product Name = ".$row['product_name']."<br>"."Category ID = ".$row['category_id']."<br>"."Category Name = ".$row['category_name']."<br>"."Price = ".$row['price']."<br>Description = ".$row['description'];
						echo '<img src="images/'.$image.'" align="left" alt="Image" height="200" width="200" style="margin:20px;margin-left:60px;" >';
						echo '<br><br><br>';
						$print =  '<a href="product.php?product_id='.$productid.'" style="color:black;">'.$data.' </a>';
						echo $print;
		  	...
		  	<div class="ct-footer-post">
		    	<div class="container">
		      		...
		      		<div class="inner-right">
		        		<p>Copyright © 2022 Computer AccessoriesCo.&nbsp;<a href="">Privacy Policy</a></p>
