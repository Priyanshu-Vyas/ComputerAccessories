			...
			<nav role="header">
				<ul>
					...
					<label for="profile2" class="profile-dropdown">
						...
						<ul>
							<li><a href="#" class="mdi mdi-textbox-password" style="display: flex;"><button type="button" class="btn btn-default btn-lg" id="changepasswordBtn" style="color: inherit;background-color: inherit;border: none;margin: 0;padding: 0;width: 100%">
			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel" style="width: 50%;margin-left: 25%;">
				...
				<div class="carousel-inner">
					<div class="item active">
						<img src="store_images/carosel1.jpg" alt="Image1" style="width:100%; height: 100%;">
					</div>
					<div class="item">
						<img src="store_images/carosel2.jpg" alt="Image2" style="width:100%; height: 100%;">
					</div>
					<div class="item">
						<img src="store_images/carosel3.jpg" alt="Image3" style="width:100%; height: 100%;">
					</div>
					<div class="item">
						<img src="store_images/carosel4.jpeg" alt="Image4" style="width:100%; height: 100%;">
					</div>
					<div class="item">
						<img src="store_images/carosel5.jpg" alt="Image5" style="width:100%; height: 100%;">
					</div>
				</div>
				...
				?>
					<div class="col-md-3 col-sm-6" style="margin-top: 25px;margin-bottom: 25px;">
						<div class="single-product">
							<div>
								<!-- <h1 style="color: black;"><?php echo $image; ?></h1> -->
								<?php
								...
								?>
								<!-- <ul>
									<li><?php //echo '<a href="product.php?product_id=' . $productid . '" class="fa fa-search"></a>'
										?></li>
							...
							<div style="text-align: center;">
								<h3><a href="product.php?product_id='<?php echo $productid; ?>'" style="color: black; font-size: 18px; font-weight: bold;" class="product-name"><?php echo $productname ?></a></h3>
								<ul>
									<li class="fa fa-star" style="color: #13A6D7;"></li>
									<li class="fa fa-star" style="color: #13A6D7;"></li>
									<li class="fa fa-star" style="color: #13A6D7;"></li>
									<li class="fa fa-star" style="color: #13A6D7;"></li>
									<li class="fa fa-star" style="color: #13A6D7;"></li>
								</ul>
								<div style="color: black; font-size: 16px; font-weight: bold; padding: 5px;">&#8377;<?php echo $productprice
													?> 
								<s style="font-size: 14px; color: grey;">&#8377;10,000</s>
								</div>
							</div>
						</div>
					</div>
